...
An electric transmission system generally consist of lines with different voltage magnitudes, ranging from a few kV to over 400 kV. As a result, it is difficult to see if the power flow in a line is high or low, because it must always be compared to the voltage level. To simplify this, quantities are generally measured relative to base values. This is called the per-unit system. Specifically,
