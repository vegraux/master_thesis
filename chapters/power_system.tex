...
A conventional electrical power system transfers power in three transmission lines that have equal voltage magnitude and phase-shifted 120 degrees. An electrical circuit of a three-phase power system is shown is figure \ref{fig:theory:three_phase}

\begin{figure}[ht!]
    \center
    \subimport{../}{circuits/three_phase.tex}
    \caption[size = 9]
    {Three-phase transmission system}\label{fig:theory:three_phase}
\end{figure}
