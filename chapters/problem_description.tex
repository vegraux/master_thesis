...
\begin{equation}
   ...
   \label{eq:problem:balance_cost}
    C_{imbalance,i} = |B_{i,t-1}| - |B_{i,t}|
    \end{aligned} 
\end{equation}
...
\begin{equation}
   ...
   \label{eq:problem:total_reward}
    ...
    \end{aligned} 
\end{equation}
where $C$ is defined by \eqref{eq:problem:total_cost}. Table \ref{table:reward_terms} summarises the different costs and their definition. 
