...
Figure \ref{fig:results:config1_improvement_voltage} shows for each hour of a day a box plot of difference between the voltage reward given to the trained agent and no agent scenario. This plot illustrates the improvements of the trained agent, measured in terms of the increase in voltage reward. 
